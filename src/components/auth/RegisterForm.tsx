...
export default function RegisterForm() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setError(null);
    try {
      const mockEmail = prompt('Enter your Google email address for OAuth registration:') || '';
      if (!mockEmail.trim()) {
        setLoading(false);
        return;
      }
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription className="text-center">Join ThriveFusion today</CardDescription>
      </CardHeader>
      <CardContent>
